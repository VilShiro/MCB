...
> _Версія 1.5 пераходная версія, у 2.0 будуць выразаны магчымасці 1.0(стварэнне праз пераазначэнне) у карысць акцэнта на сыстэме кіравання анатаціямі, а таксама будуць рэалізаваныя функцыі шматструменнай працы

> _Функцыянал шматкарыстоўчай рэалізацыі не была _
